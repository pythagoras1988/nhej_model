...
class NhejProcess:
	def __init__(self,dsbMasterData,chromPos,totalDose):
		##-----------------------------------------
		# Program I/O
		##-----------------------------------------
	...
	def _InitializeDsbStates(self):
		...
		print('Total Number of DSBs ends = %d ...' %self.numDSB)
...
class LogData:
	def __init__(self,dose=None,numDSB=None):
	...
	def GetStateListData(self,stateList):
		pass
