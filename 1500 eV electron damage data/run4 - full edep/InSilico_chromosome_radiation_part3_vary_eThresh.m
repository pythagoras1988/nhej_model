...
eThresh_data(mm,1) = mean(masterData(4,1:end-1))/unitFactor;
eThresh_data(mm,2) = std(masterData(4,1:end-1))/unitFactor;
eThresh_data(mm,3) = mean(masterData(5,1:end-1))/unitFactor;
eThresh_data(mm,4) = std(masterData(5,1:end-1))/unitFactor
eThresh_data(mm,5) = eThresh_values(mm);

end

save('eThresh_data_1500eV','eThresh_data'); 
